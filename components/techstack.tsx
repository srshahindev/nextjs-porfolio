  ...
  return (
    <section className='pt-12'>
      ...
      <div className='-mt-32 flex flex-col items-center justify-center gap-0 md:mt-0 md:flex-row md:justify-between md:gap-12 lg:-mt-40'>
        ...
        <div className='hover:border-coralColor -mt-24 flex w-full flex-2/3 flex-col gap-8 rounded-md border border-transparent bg-slate-800 p-8 shadow-md md:mt-0 md:p-10'>
